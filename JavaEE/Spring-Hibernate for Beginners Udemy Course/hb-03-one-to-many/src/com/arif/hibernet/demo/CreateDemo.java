...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {			
			...
			//create the object
			Instructor tempInstructor = new Instructor("Arifa", "Parveaz", "arifa.mbstu22@gmail.com");
			InstructorDetails tempInstructorDetails = new InstructorDetails("http://love2Codee.com","Love2Codee");
